"""Run TRAM V1 inference on a folder of images.

Saves side-by-side detection and segmentation visualizations. If labels are
available alongside the images, also reports COCO-style mAP via the shared
evaluator.
