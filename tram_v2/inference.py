"""Run TRAM V2 inference on a folder of images.

Same I/O as V1 but loads V2 weights into the V1+CBAM architecture.
"""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="TRAM V2 inference")
    p.add_argument("--weights", required=True)
    p.add_argument("--data-root", required=True)
    p.add_argument("--output-dir", default="runs/tram_v2/inference")
